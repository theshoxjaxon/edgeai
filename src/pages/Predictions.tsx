      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-[#011627] to-[#0A2A3A] border border-[#00F5FF]/10 rounded-xl p-4 mb-6"
          >
            <div className="flex flex-col lg:flex-row gap-4">
              {/* Search */}
              <div className="relative flex-1">
                <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#00F5FF]" />
                <input
                  type="text"
                  value={searchQuery}
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none px-4 py-3 pr-10 bg-[#0A2A3A] border border-[#00F5FF]/20 rounded-lg text-[#FFFFFF] focus:outline-none focus:border-[#CCFF00]/50 min-w-[160px]"
                >
                  {leagues.map(league => (
            ...
            <div className="divide-y divide-[#00F5FF]/10">
              {filteredMatches.map((match, index) => (
                <motion.a
                  ...
                  className="block lg:grid lg:grid-cols-12 gap-4 p-4 hover:bg-[#0A2A3A] transition-colors items-center"
                >
                  {/* Match Info */}
                  <div className="lg:col-span-4 mb-4 lg:mb-0">
                    <div className="flex items-center gap-3">
                      <div className="flex -space-x-2">
                        <div className="w-10 h-10 rounded-full bg-[#0A2A3A] border-2 border-[#011627] flex items-center justify-center">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          <span className="text-[#CCFF00] text-xs">{match.kickoff}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-2 mb-4 lg:mb-0">
                    <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#CCFF00]/10 text-[#CCFF00] rounded-full text-sm font-medium">
                      <Target className="w-4 h-4" />
                      {match.prediction}
                    </span>
                    <p className="text-[#00F5FF] text-xs mt-1">{match.confidence}% confidence</p>
                  </div>
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      <div className="flex-1">
                        <div className="h-2 bg-[#0A2A3A] rounded-full overflow-hidden flex">
                          <div className="h-full bg-[#CCFF00]" style={{ width: `${match.homeProb}%` }} />
                          <div className="h-full bg-[#00F5FF]" style={{ width: `${match.drawProb}%` }} />
                          <div className="h-full bg-[#00F5FF]/50" style={{ width: `${match.awayProb}%` }} />
                        </div>
                        <div className="flex justify-between text-xs mt-1">
                          <span className="text-[#CCFF00]">H {match.homeProb}%</span>
                          <span className="text-[#00F5FF]">D {match.drawProb}%</span>
                          <span className="text-[#00F5FF]/70">A {match.awayProb}%</span>
                        </div>
                      </div>
                    </div>
                  </div>
